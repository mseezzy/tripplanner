...
const PRESETS = [
  {
    ...
    members: [
      { name: 'Parent 1', age: 36, role: 'Adult' },
      { name: 'Parent 2', age: 34, role: 'Adult' },
      { name: 'Emma', age: 6, role: 'Child' },
      { name: 'Leo', age: 2, role: 'Toddler' }
    ],
    likes: ['theme_parks', 'beaches', 'animals_wildlife', 'water_parks'],
  ...
  },
  {
    ...
    members: [
      { name: 'Parent 1', age: 44, role: 'Adult' },
      { name: 'Parent 2', age: 42, role: 'Adult' },
      { name: 'Jack', age: 16, role: 'Teen' },
      { name: 'Maya', age: 13, role: 'Teen' }
    ],
    likes: ['adventure', 'nature', 'science_museums', 'food_culinary'],
  ...
  },
  {
    ...
    members: [
      { name: 'Mom', age: 38, role: 'Adult' },
      { name: 'Dad', age: 39, role: 'Adult' },
      { name: 'Sophia', age: 9, role: 'Tween' }
    ],
    likes: ['beaches', 'food_culinary', 'science_museums'],
    dislikes: ['avoid_heat'],
    destination: '',
    duration: 7
  }
...
export default function FamilyForm({ onSubmit, loading }) {
  const theme = useTheme();

  const [familyMembers, setFamilyMembers] = useState([
    { name: 'Parent 1', age: 36, role: 'Adult' },
    { name: 'Parent 2', age: 34, role: 'Adult' },
    { name: 'Child 1', age: 7, role: 'Child' },
    { name: 'Toddler', age: 2, role: 'Toddler' },
  ]);

  const [likes, setLikes] = useState(['theme_parks', 'animals_wildlife', 'beaches']);
  const [dislikes, setDislikes] = useState(['stroller_friendly']);
  ...
  const [originCity, setOriginCity] = useState('Chicago (ORD)');
  const [budgetTier, setBudgetTier] = useState('moderate');

  const addMember = () => {
    setFamilyMembers([
      ...familyMembers,
      { name: `Member ${familyMembers.length + 1}`, age: 10, role: 'Tween' }
    ]);
  };
